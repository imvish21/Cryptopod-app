...
// Move the contract deployment logic to a function
const deployContract = async (web3) => {
    // ... (your existing code for contract deployment)
    // ... (other imports)
...
etherTransactionContract.options.address = contractAddress;
  ...
  document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Deploy the contract and get the deployed instance
    const etherTransactionContract = await deployContract(web3);
    ...
    // Expose the transferEther function globally
    window.transferEther = async (recipientAddress, amount) => {
      try {
  ...
  export { deployContract }; // Export the deployContract function
